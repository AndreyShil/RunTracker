...
class TrackerViewModelFactoryTest {
    ...
    private lateinit var factoryUnderTest: TrackerViewModelFactory

    @Before
    fun setup() {
        factoryUnderTest = TrackerViewModelFactory(
    ...
    fun should_be_a_instance_of_trackerViewModel() {
        val expectedViewModelClass = TrackerViewModel::class.java
